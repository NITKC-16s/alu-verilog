$(document).ready(function () {
    ...
    $(".open_literature").click(function() {
        QUARTUS.open_link("http://www.altera.com/literature/lit-qts.jsp?xy=gettingstartedlit");
        return false;
    });
    $(".open_training").click(function() {
        QUARTUS.open_link("http://www.altera.com/education/training/curriculum/fpga/trn-fpga.html?xy=gettingstartedtrain");
        return false;
    });
